...
l1 =Label(root, text = "Posture System", font= ('Helvetica 25 bold')).place(relx=.5, rely=0,anchor= N)
...
def browsefunc():
   ...
   if mimestart == 'video':
      ...
      pass
b1=Button(root,text="Browse for a video or an picture",font=40,command=browsefunc).place(relx=.5, rely=.2,anchor= N)
